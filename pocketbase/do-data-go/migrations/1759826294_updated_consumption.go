...
func init() {
	m.Register(func(app core.App) error {
		...
		// remove field
		collection.Fields.RemoveById("_clone_iKik")

		// remove field
		collection.Fields.RemoveById("_clone_xP2u")

		// remove field
		collection.Fields.RemoveById("_clone_I5Ob")

		// remove field
		collection.Fields.RemoveById("_clone_IKYX")
