...
func init() {
	m.Register(func(app core.App) error {
		...
		// remove field
		collection.Fields.RemoveById("_clone_4OcZ")

		// remove field
		collection.Fields.RemoveById("_clone_3PGw")

		// remove field
		collection.Fields.RemoveById("_clone_HHNK")

		// remove field
		collection.Fields.RemoveById("_clone_Kask")

		// remove field
		collection.Fields.RemoveById("_clone_zCI3")

		// remove field
		collection.Fields.RemoveById("_clone_oXfk")
